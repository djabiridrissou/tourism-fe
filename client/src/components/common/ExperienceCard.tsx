  ...
  return (
    <div className="group relative rounded-xl overflow-hidden shadow-md">
      ...
      <div className="absolute bottom-0 left-0 p-6">
        <span className={`${getCategoryColor(experience.category)} px-3 py-1 rounded-full text-white text-xs font-medium mb-3 inline-block`}>
          {experience.category}
        </span>
        <h3 className="text-xl font-bold text-white font-montserrat mb-2">{experience.title}</h3>
