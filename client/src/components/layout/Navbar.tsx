...
const Navbar = () => {
  ...
  return (
    <nav className={`fixed w-full z-10 transition-all duration-300 ${
      ...
      location === "/" ? "bg-transparent" : "bg-white shadow-md"
    }`}>
          ...
          <div className="flex items-center">
            <Link href="/" className="flex-shrink-0 flex items-center">
              <div className="h-10 w-10 rounded-full bg-[#006B3F] flex items-center justify-center">
                <span className="text-white font-playfair text-lg font-bold">DG</span>
              </div>
              <span className="ml-3 text-lg font-bold text-[#006B3F] font-montserrat">DiscoverGhana</span>
            </Link>
          </div>
              ...
              <SheetTrigger asChild>
                ...
                >
                  <Menu className={`h-6 w-6 ${
                    (location === "/" && !isScrolled) ? "text-white" : "text-neutral-800"
                  }`} />
                </Button>
              </SheetTrigger>
