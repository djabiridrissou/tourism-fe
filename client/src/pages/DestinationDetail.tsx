          ...
          <div className="container mx-auto px-4 h-full flex flex-col justify-end pb-10">
            ...
            <div className="flex items-center text-white mb-2">
              ...
              <div className="ml-4 flex items-center">
                ...
                <span>{destination.rating / 10} / 5</span>
              </div>
            </div>
        ...
        <Tabs defaultValue="overview">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
              <div className="lg:col-span-2">
                ...
                <ul className="list-disc pl-5 mb-6">
                  {Array.isArray(destination.topAttractions) && destination.topAttractions.map((attraction, index) => (
                    <li key={index} className="mb-1 text-gray-700">{attraction}</li>
                  ))}
                </ul>
              </div>
              ...
              <div>
                <Card>
                  <CardContent className="p-6">
                    ...
                    <p className="text-gray-700 mb-6">Ready to experience {destination.name}? Book your trip now!</p>
                ...
                <Card key={index}>
                  <CardContent className="p-6">
                    ...
                    <p className="text-gray-700">
                      Detailed information about this attraction would be displayed here.
                    </p>
                  </CardContent>
                </Card>
              ))}
          ...
          <TabsContent value="reviews" className="mt-0">
            ...
            {isLoadingReviews ? (
              ...
              <p className="text-gray-500 text-center py-10">No reviews yet. Be the first to review this destination!</p>
            ) : (
          ...
          <TabsContent value="map" className="mt-0">
            ...
            <div className="bg-gray-200 rounded-lg h-96 flex items-center justify-center">
              <div className="text-center">
                <p className="text-lg text-gray-700 mb-2">Interactive map would be displayed here</p>
