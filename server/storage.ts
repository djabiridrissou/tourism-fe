...
export interface IStorage {
  ...
  updateUserPreferences(userId: number, preferences: Partial<Preference>): Promise<Preference | undefined>;
}
...
export class MemStorage implements IStorage {
  ...
  private initializeData() {
    ...
    const destinations: InsertDestination[] = [
      ...
      },
      {
        ...
        description: "Ghana's largest wildlife sanctuary featuring diverse flora and fauna. Mole offers visitors the chance to see elephants, antelopes, and various bird species in their natural habitat. Walking safaris with armed rangers provide an up-close wildlife experience.",
        shortDescription: "Ghana's largest wildlife sanctuary featuring diverse flora and fauna.",
        imageUrl: "https://images.unsplash.com/photo-1523805009345-7448845a9e53?ixlib=rb-1.2.1&auto=format&fit=crop&w=600&q=80",
        rating: 48,
    ...
    const hiddenGems: InsertHiddenGem[] = [
      ...
      },
      {
        ...
        description: "A community-based ecotourism initiative protecting sacred mona monkeys in their natural habitat.",
        imageUrl: "https://images.unsplash.com/photo-1554866585-e4b14f4251b8?ixlib=rb-1.2.1&auto=format&fit=crop&w=500&q=80",
        region: "Volta Region"
      },
      {
        name: "Paga Crocodile Pond",
        description: "A sacred site where crocodiles live in harmony with humans, believed to host the souls of the ancestors.",
        imageUrl: "https://images.unsplash.com/photo-1564419320461-6870880221a0?ixlib=rb-1.2.1&auto=format&fit=crop&w=500&q=80",
        region: "Upper East Region"
      },
      {
        name: "Wli Waterfalls",
        description: "The highest waterfall in West Africa, situated in a stunning valley surrounded by lush forests and mountains.",
        imageUrl: "https://images.unsplash.com/photo-1604762512526-b7068d08e169?ixlib=rb-1.2.1&auto=format&fit=crop&w=500&q=80",
        region: "Volta Region"
      }
    ];
    ...
    const events: InsertEvent[] = [
      {
        ...
        description: "A traditional harvest festival celebrated by the Ga people with drumming and dance.",
      ...
      },
      {
        ...
        description: "Annual street art festival showcasing alternative art, music, dance, and performance.",
      ...
      },
      {
        ...
        description: "Royal ceremony celebrating Ashanti heritage with colorful processions and traditional music.",
  ...
  async subscribeToNewsletter(insertNewsletter: InsertNewsletter): Promise<Newsletter> {
    const existingSubscriber = await this.getSubscriberByEmail(insertNewsletter.email);
  ...
  async saveUserPreferences(insertPreference: InsertPreference): Promise<Preference> {
    const existingPreference = await this.getUserPreferences(insertPreference.userId);
  ...
  async updateUserPreferences(userId: number, preferences: Partial<Preference>): Promise<Preference | undefined> {
